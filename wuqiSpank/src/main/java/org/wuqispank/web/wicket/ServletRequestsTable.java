...
public class ServletRequestsTable extends WebMarkupContainer {

	/**
	 * 
	 */
	private static final long serialVersionUID = -2490345863552611919L;


		public ServletRequestsTable(String id)
		{
			super(id);
