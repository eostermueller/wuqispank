 ...
 *
 */
public class XmlSwimlanes_8 extends HttpServlet {
    /**
	 * 
	 */
...
//    	swimlaneLoader.setMxGraphFolder("mxGraph-2_4_0_4");
    	...
    	swimlaneLoader.setJavaScript("/js/XmlSwimlanes_8.js");
...
class wsStackLayout_8 extends mxStackLayout {

	public wsStackLayout_8(mxGraph graph, boolean b) {
		super(graph, b);
		this.resizeParent = true;
		this.y0 = 0;
		this.x0 = 0;
	...
	public boolean isVertexIgnored(Object o) {
		...
		if (getGraph().isSwimlane(o)) {
			...
			if (XmlSwimlanes_8.STYLE_WUQISPANK_ROW_ODD.equals(cell.getStyle())) {
				rc = false;
			} else if (XmlSwimlanes_8.STYLE_WUQISPANK_ROW_EVEN.equals(cell.getStyle())) {
				rc = false;
			}
		}
