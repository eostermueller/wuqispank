 ...
 *
 */
public class XmlSwimlanes_10 extends HttpServlet {
    /**
	 * 
	 */
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException    {
    	...
    	swimlaneLoader.setJavaScript("/js/XmlSwimlanes_10.js");
	...
	private Object[] insertPopulatedLane(mxGraph graph, Object pool, boolean collapsed) {
        ...
        Object myVerticalLane1 = myVerticalTableLanes[0];
        Object myVerticalLane3 = myVerticalTableLanes[2];
        Object myVerticalLane4 = myVerticalTableLanes[3];
        Object v1 = (mxICell)graph.insertVertex(myVerticalLane1, null, null, x_sphere,    y_sphere, 20, 20,STYLE_WUQISPANK_SPHERE);

        Object v3 = graph.insertVertex(myVerticalLane3, null, null, x_sphere,    y_sphere, 20, 20,STYLE_WUQISPANK_SPHERE);
        Object v4 = graph.insertVertex(myVerticalLane4, null, null, x_sphere,    y_sphere, 20, 20,STYLE_WUQISPANK_SPHERE);
        mxICell e1 = (mxICell)graph.insertEdge(pool, null, "", v1, v3, STYLE_WUQISPANK_JOIN_EDGE);
        
        mxICell e2 = (mxICell)graph.insertEdge(pool, null, "", v1, v4, STYLE_WUQISPANK_JOIN_EDGE);
        mxPoint edgePoint = new mxPoint(110, 50);
        List<mxPoint> myList = new ArrayList<mxPoint>();
        myList.add(edgePoint);
        e2.getGeometry().setPoints(myList);
	...
	private mxICell[] insertVerticalTableLanes(mxGraph graph, Object lane) {
		...
		for (int i = 0; i < 4; i++) {
			...
			System.out.println("type of vertical table lane [" + insertVertex.getClass().getName() + "]");
