...
//				"tab1", "col1", "tab2", "col2");
		...
		assertTrue("Couldn't find join",validateLeftSide(getJoins(model),"J_BCAC","J_CAMI"));
		assertTrue("Couldn't find join",validateLeftSide(getJoins(model),"J_CRAI","J_CAMS"));
		assertTrue("Couldn't find join",validateLeftSide(getJoins(model),"J_BFEI","J_CALM"));
		assertTrue("Couldn't find join",validateLeftSide(getJoins(model),"J_BFFC","J_CALM"));
